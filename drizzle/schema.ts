...
export const cachedContacts = mysqlTable("cached_contacts", {
	...
	addressModified: tinyint().default(0),
...
export const routeWaypoints = mysqlTable("route_waypoints", {
	...
	isGapStop: tinyint().default(0).notNull(),
	gapDuration: int(),
	gapDescription: text(),
...
export const routes = mysqlTable("routes", {
	...
	totalDistance: int(),
	totalDuration: int(),
	optimized: tinyint().default(1).notNull(),
	hasManualOrder: tinyint().default(0).notNull(),
	createdAt: timestamp({ mode: 'string' }).default('CURRENT_TIMESTAMP').notNull(),
	updatedAt: timestamp({ mode: 'string' }).defaultNow().onUpdateNow().notNull(),
	folderId: int(),
	notes: text(),
	shareToken: varchar({ length: 36 }),
	isPubliclyAccessible: tinyint().default(0).notNull(),
