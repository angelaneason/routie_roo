...
## Contact Export Feature - Dec 3, 2025

- [x] Add contact export to CSV functionality
  - [x] Create backend procedure to fetch all user contacts with full data
  - [x] Format contacts as CSV with all fields (name, email, address, phone numbers, labels, important dates, comments)
